...
void kernel_module_add(CPUState *env, char *mod_name, char *mod_filename, target_ulong size, target_ulong base) {
    printf("KERNEL MODULE: Loaded module %s - %s\n", mod_name, mod_filename);
}

void kernel_module_remove(CPUState *env, char *mod_name, char *mod_filename, target_ulong size, target_ulong base) {
    printf("KERNEL MODULE: Remove module %s - %s\n", mod_name, mod_filename);
}
