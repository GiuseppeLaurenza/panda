...
void pri_runcb_on_fn_return(CPUState *cpu, target_ulong pc, const char *file_name, const char *funct_name, unsigned long long lno){
    PPP_RUN_CB(on_fn_return, cpu, pc, file_name, funct_name, lno);
}
